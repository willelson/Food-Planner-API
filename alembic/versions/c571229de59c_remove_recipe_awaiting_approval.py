"""Remove recipe awaiting approval

Revision ID: c571229de59c
Revises: c96df163e67c
Create Date: 2024-10-01 05:36:15.569910
...
revision: str = 'c571229de59c'
down_revision: Union[str, None] = 'c96df163e67c'
...
def downgrade() -> None:
    ...
    sa.Column('site_name', sa.VARCHAR(), nullable=True),
    sa.Column('awaiting_approval', sa.BOOLEAN(), nullable=True),
    sa.Column('user_id', sa.INTEGER(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
